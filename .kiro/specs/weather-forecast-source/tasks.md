...
- [x] 1. Extend backend API response with source fields
  - [x] 1.1 Add `SOURCE` and `SOURCE_URL` module-level constants to `src/lambda_handler.py`
  ...
  - [x] 1.2 Write unit tests for source fields in `tests/unit/test_lambda_handler.py`
  ...
  - [x] 1.3 Write property test for Property 2: API response always contains source fields
  ...
  - [x] 1.4 Write property test for Property 3: source fields present even on total fetch failure
...
- [x] 2. Create `Attribution` React component
  - [x] 2.1 Create `frontend/src/components/Attribution.js` and `Attribution.css`
  ...
  - [x] 2.2 Integrate `Attribution` into `WeatherDisplay`
  ...
  - [x] 2.3 Write unit tests for `Attribution` in `frontend/src/components/Attribution.test.js`
  ...
  - [x] 2.4 Write property test for Property 1: WeatherDisplay renders attribution name and link
  ...
  - [x] 2.5 Extend `WeatherDisplay.test.js` with attribution integration test
