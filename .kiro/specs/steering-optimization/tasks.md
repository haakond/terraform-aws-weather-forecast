...
- [ ] 1. Set up property-based test infrastructure
...
- [ ] 2. Write property-based tests (all 6 properties)
  - [ ] 2.1 Write Property 1 test: only approved files use `inclusion: always`
  ...
  - [ ] 2.3 Write Property 2 test: every `auto` file has unique kebab-case name and non-empty description
  ...
  - [ ] 2.4 Write Property 3 test: every `fileMatch` file has a `fileMatchPattern`
  ...
  - [ ] 2.5 Write Property 4 test: no `##`-level section heading appears in more than one steering file
  ...
  - [ ] 2.6 Write Property 5 test: each steering file maps to exactly one domain
  ...
  - [ ] 2.7 Write Property 6 test: all steering filenames are kebab-case
